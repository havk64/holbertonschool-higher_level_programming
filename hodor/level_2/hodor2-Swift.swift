...
//===---Description:------------------------------------------------------------===//
// Swift script to solve Hodor Level 2 Project by Julien Barbier - Holberton
// School.
...
func post() {
    ...
    let url = NSURL(string: "http://173.246.108.142/level2.php")
    ...
    request.setValue("Windows NT 100 v0.0.1alphaBetaGamaDelta (aka: BlueScreen of Death) havk64 - Swift Requests",  forHTTPHeaderField: "User-Agent") // Use your own User-Agent setting.
    request.setValue("HoldTheDoor=" + cookie, forHTTPHeaderField: "Cookie")
    request.setValue("http://173.246.108.142/level2.php", forHTTPHeaderField: "Referer")
...
func getCookie() -> String {
    return "c63e8f4583e0fc89436699268e402b6a441281c9"
}
var counter = 0
